...
'=KiteDart1,S=+[/A]F/---[-S]F-F---[-S]*F[/|A],A=[/S]+F/[|A]----F+F----[A]*F,F=f,_a=36,_l=99,_m=1.6180339887498948,_n=4',
'=KiteDart2,S=[k]++[k]++[k]++[k]++[k],A=[/k]+F/[|A]----F+F----[A]*F,F=f,_a=36,_l=99,_m=1.6180339887498948,k=+[/A]F/---[-k]F-F---[-k]*F[/|A],_n=4',
'=KiteDart3,S=Wf+Xf+Wf+Xf+Wf+Xf+Wf+Xf+Wf+X,F=,W=[F][++*F][++f---/f|X-Y|f|W],X=[F+++*F][++/fZ|X|-f|W],Y=[+F][*F][+f/|Y+X],Z=[-F][*F][/f--Wf|+Z],_a=36,_l=99,_m=1.6180339887498948,_n=4',
...
'=plant14,S=x,A=c,F=*F/,b=e,c=o,e=h,h=j,j=y,o=p,p=x,x=F[+A(4)]Fy,y=F[-b(4)]Fx,_a=45,_m=1.18,_n=20,_l=1',
'=0+0+10x10,S=f+f-FFF+FFF,_l=2',
'S=f+f-fSF+FSF,_n=4',
'S=[F+fff+[f,f=F,F=S!Sf+],_n=8',
];
